...
angular.module("frontendStableApp", ["ngAnimate", "ngAria", "ngCookies", "ngMessages", "ngResource", "ngRoute", "ngSanitize", "ngMaterial", "ngFileUpload"]).config(["$routeProvider", function(a) {
  ...
  return a.isLogged() ? void g() : (e("left").close(), d.$emit("sidenav-close"), d.$emit("toolbar-hide"), b.user = {
    username: "",
    password: ""
  }, b.loading = !1, b.loginForm = !0, b.loadingMessage = "Accesso in corso...", b.errorMessage = null, b.loading || (d.theme = "guest"), a.hasAuthToken() && (b.loadingMessage = "Ripresa della sessione...", b.loginForm = !1, b.loading = !0, a.getSessionInfo().then(function() {
    g()
  }, function() {
    ...
    d.$emit("sidenav-open"), d.$emit("toolbar-show"), a.guestLogin(), c.search().redirect ? (c.path(c.search().redirect), c.search({})) : c.path("/problems")
  }))
